...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/data/small_dataset/train.json',
        img_prefix='/data/small_dataset/train_img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/data/small_dataset/test.json',
        img_prefix='/data/small_dataset/test_img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
